  ...
  describe('parsing', function () {
    it('basic', function () {
      ...
      return mmtfParser.parse().then(function (structure) {
        ...
        expect(structure.bondCount).toBe(432)
        ...
        expect(structure.bondSet.length).toBe(432)
        expect(structure.backboneBondStore.count).toBe(1)
        ...
        expect(structure.bondHash.indexArray.length).toBe(432 * 2)
